...
/**
 * Esta clase implementa la interfaz ICriteria y representa un criterio que se
 * aplica a una actividad en un campamento.
 */
public class ActivityInCampCriteria implements ICriteria {
	private int campID;

	/**
	 * Este es el constructor de la clase ActivityInCampCriteria.
	 * 
	...
	/**
	 * Este método se utiliza para aplicar el criterio a un objeto
	 * PreparedStatement.
	 * 
